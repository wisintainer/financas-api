...
import com.wisintainer.projetoTeste.api.dto.AtualizaStatusDTO;
import com.wisintainer.projetoTeste.api.dto.LancamentoDTO;
...
import com.wisintainer.projetoTeste.model.enums.TipoLancamento;
...
public class LancamentoController {
	...
	public ResponseEntity atualizar(@PathVariable("id") Long id, @RequestBody LancamentoDTO dto) {
		...
		}).orElseGet(() -> new ResponseEntity("Lançamento nao encontrato na base de dados", HttpStatus.BAD_REQUEST));
	}
